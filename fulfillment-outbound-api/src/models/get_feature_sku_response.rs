...
pub struct GetFeatureSkuResponse {
  ...
  payload: Option<::models::GetFeatureSkuResult>,
  #[serde(rename = "errors")]
...
impl GetFeatureSkuResponse {
  ...
  pub fn set_payload(&mut self, payload: ::models::GetFeatureSkuResult) {
    self.payload = Some(payload);
  }

  pub fn with_payload(mut self, payload: ::models::GetFeatureSkuResult) -> GetFeatureSkuResponse {
    self.payload = Some(payload);
    self
  }

  pub fn payload(&self) -> Option<&::models::GetFeatureSkuResult> {
    self.payload.as_ref()
  }
  ...
  pub fn with_errors(mut self, errors: ::models::ErrorList) -> GetFeatureSkuResponse {
    self.errors = Some(errors);
    self
  }
