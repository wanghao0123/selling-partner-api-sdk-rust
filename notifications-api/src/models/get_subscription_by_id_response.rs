...
pub struct GetSubscriptionByIdResponse {
  ...
  payload: Option<::models::Subscription>,
...
impl GetSubscriptionByIdResponse {
  ...
  pub fn set_payload(&mut self, payload: ::models::Subscription) {
    self.payload = Some(payload);
  }

  pub fn with_payload(mut self, payload: ::models::Subscription) -> GetSubscriptionByIdResponse {
    self.payload = Some(payload);
    self
  }

  pub fn payload(&self) -> Option<&::models::Subscription> {
    self.payload.as_ref()
  }
  ...
  pub fn with_errors(mut self, errors: ::models::ErrorList) -> GetSubscriptionByIdResponse {
    self.errors = Some(errors);
    self
  }
