...
pub struct PartyIdentification {
  ...
  tax_registration_details: Option<Vec<::models::TaxRegistrationDetail>>
}
...
impl PartyIdentification {
  ...
  pub fn set_tax_registration_details(&mut self, tax_registration_details: Vec<::models::TaxRegistrationDetail>) {
    self.tax_registration_details = Some(tax_registration_details);
  }

  pub fn with_tax_registration_details(mut self, tax_registration_details: Vec<::models::TaxRegistrationDetail>) -> PartyIdentification {
    self.tax_registration_details = Some(tax_registration_details);
    self
  }

  pub fn tax_registration_details(&self) -> Option<&Vec<::models::TaxRegistrationDetail>> {
