...
impl CreateConfirmCustomizationDetailsRequest {
  ...
  pub fn with_text(mut self, text: String) -> CreateConfirmCustomizationDetailsRequest {
    self.text = Some(text);
    self
  }
  ...
  pub fn with_attachments(mut self, attachments: Vec<::models::Attachment>) -> CreateConfirmCustomizationDetailsRequest {
    self.attachments = Some(attachments);
    self
  }
