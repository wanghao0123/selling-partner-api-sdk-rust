...
impl GetMessagingActionsForOrderResponse {
  ...
  pub fn with__links(mut self, _links: Value) -> GetMessagingActionsForOrderResponse {
    self._links = Some(_links);
    self
  }
  ...
  pub fn with__embedded(mut self, _embedded: Value) -> GetMessagingActionsForOrderResponse {
    self._embedded = Some(_embedded);
    self
  }
  ...
  pub fn with_errors(mut self, errors: ::models::ErrorList) -> GetMessagingActionsForOrderResponse {
    self.errors = Some(errors);
    self
  }
