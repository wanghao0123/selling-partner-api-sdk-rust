...
# **cancel_shipment_old**
> ::models::CancelShipmentResponse cancel_shipment_old(shipment_id)
...
> ::models::GetAdditionalSellerInputsResponse get_additional_seller_inputs_old(body)
...
> ::models::GetEligibleShipmentServicesResponse get_eligible_shipment_services_old(body)
