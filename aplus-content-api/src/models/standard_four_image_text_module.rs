...
pub struct StandardFourImageTextModule {
  ...
  #[serde(rename = "block4")]
  block4: Option<::models::StandardImageTextBlock>
}
...
impl StandardFourImageTextModule {
  ...
  pub fn with_headline(mut self, headline: ::models::TextComponent) -> StandardFourImageTextModule {
    self.headline = Some(headline);
    self
  }
  ...
  pub fn with_block1(mut self, block1: ::models::StandardImageTextBlock) -> StandardFourImageTextModule {
    self.block1 = Some(block1);
    self
  }
  ...
  pub fn with_block2(mut self, block2: ::models::StandardImageTextBlock) -> StandardFourImageTextModule {
    self.block2 = Some(block2);
    self
  }
  ...
  pub fn with_block3(mut self, block3: ::models::StandardImageTextBlock) -> StandardFourImageTextModule {
    self.block3 = Some(block3);
    self
  }
  ...
  pub fn set_block4(&mut self, block4: ::models::StandardImageTextBlock) {
    self.block4 = Some(block4);
  }

  pub fn with_block4(mut self, block4: ::models::StandardImageTextBlock) -> StandardFourImageTextModule {
    self.block4 = Some(block4);
    self
  }

  pub fn block4(&self) -> Option<&::models::StandardImageTextBlock> {
    self.block4.as_ref()
  }

  pub fn reset_block4(&mut self) {
    self.block4 = None;
  }
