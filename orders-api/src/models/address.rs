...
impl Address {
  ...
  pub fn set_municipality(&mut self, municipality: String) {
    self.municipality = Some(municipality);
  }

  pub fn with_municipality(mut self, municipality: String) -> Address {
    self.municipality = Some(municipality);
    self
  }
  ...
  pub fn reset_municipality(&mut self) {
  ...
  pub fn with_address_type(mut self, address_type: String) -> Address {
    self.address_type = Some(address_type);
    self
  }
