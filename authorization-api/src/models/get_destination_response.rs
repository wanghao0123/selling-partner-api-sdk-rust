...
impl GetDestinationResponse {
  ...
  pub fn with_payload(mut self, payload: ::models::Destination) -> GetDestinationResponse {
    self.payload = Some(payload);
    self
  }
  ...
  pub fn with_errors(mut self, errors: ::models::ErrorList) -> GetDestinationResponse {
    self.errors = Some(errors);
    self
  }
