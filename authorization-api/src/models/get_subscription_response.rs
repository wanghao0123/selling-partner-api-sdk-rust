...
impl GetSubscriptionResponse {
  ...
  pub fn with_payload(mut self, payload: ::models::Subscription) -> GetSubscriptionResponse {
    self.payload = Some(payload);
    self
  }
  ...
  pub fn with_errors(mut self, errors: ::models::ErrorList) -> GetSubscriptionResponse {
    self.errors = Some(errors);
    self
  }
