...
impl CreateSubscriptionResponse {
  ...
  pub fn with_payload(mut self, payload: ::models::Subscription) -> CreateSubscriptionResponse {
    self.payload = Some(payload);
    self
  }
  ...
  pub fn with_errors(mut self, errors: ::models::ErrorList) -> CreateSubscriptionResponse {
    self.errors = Some(errors);
    self
  }
