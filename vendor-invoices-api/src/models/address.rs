...
pub struct Address {
  ...
  #[serde(rename = "postalOrZipCode")]
  postal_or_zip_code: Option<String>,
...
impl Address {
  ...
  pub fn set_postal_or_zip_code(&mut self, postal_or_zip_code: String) {
    self.postal_or_zip_code = Some(postal_or_zip_code);
  }

  pub fn with_postal_or_zip_code(mut self, postal_or_zip_code: String) -> Address {
    self.postal_or_zip_code = Some(postal_or_zip_code);
    self
  }

  pub fn postal_or_zip_code(&self) -> Option<&String> {
    self.postal_or_zip_code.as_ref()
  }

  pub fn reset_postal_or_zip_code(&mut self) {
    self.postal_or_zip_code = None;
  }
