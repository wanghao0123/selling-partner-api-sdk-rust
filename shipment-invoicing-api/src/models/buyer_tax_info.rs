...
pub struct BuyerTaxInfo {
  ...
  tax_classifications: Option<::models::TaxClassificationList>
}
...
impl BuyerTaxInfo {
  ...
  pub fn set_tax_classifications(&mut self, tax_classifications: ::models::TaxClassificationList) {
    self.tax_classifications = Some(tax_classifications);
  }

  pub fn with_tax_classifications(mut self, tax_classifications: ::models::TaxClassificationList) -> BuyerTaxInfo {
    self.tax_classifications = Some(tax_classifications);
    self
  }

  pub fn tax_classifications(&self) -> Option<&::models::TaxClassificationList> {
