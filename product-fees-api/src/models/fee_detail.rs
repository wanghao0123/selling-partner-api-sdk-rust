...
pub struct FeeDetail {
  ...
  #[serde(rename = "IncludedFeeDetailList")]
  included_fee_detail_list: Option<::models::IncludedFeeDetailList>
}

impl FeeDetail {
  /// The type of fee, fee amount, and other details.
  pub fn new(fee_type: String, fee_amount: ::models::MoneyType, final_fee: ::models::MoneyType) -> FeeDetail {
    FeeDetail {
      fee_type: fee_type,
  ...
  pub fn with_fee_type(mut self, fee_type: String) -> FeeDetail {
    self.fee_type = fee_type;
    self
  }
  ...
  pub fn with_fee_amount(mut self, fee_amount: ::models::MoneyType) -> FeeDetail {
    self.fee_amount = fee_amount;
    self
  }
  ...
  pub fn with_fee_promotion(mut self, fee_promotion: ::models::MoneyType) -> FeeDetail {
    self.fee_promotion = Some(fee_promotion);
    self
  }
  ...
  pub fn with_tax_amount(mut self, tax_amount: ::models::MoneyType) -> FeeDetail {
    self.tax_amount = Some(tax_amount);
    self
  }
  ...
  pub fn with_final_fee(mut self, final_fee: ::models::MoneyType) -> FeeDetail {
    self.final_fee = final_fee;
    self
  }
  ...
  pub fn set_included_fee_detail_list(&mut self, included_fee_detail_list: ::models::IncludedFeeDetailList) {
    self.included_fee_detail_list = Some(included_fee_detail_list);
  }

  pub fn with_included_fee_detail_list(mut self, included_fee_detail_list: ::models::IncludedFeeDetailList) -> FeeDetail {
    self.included_fee_detail_list = Some(included_fee_detail_list);
    self
  }

  pub fn included_fee_detail_list(&self) -> Option<&::models::IncludedFeeDetailList> {
    self.included_fee_detail_list.as_ref()
  }

  pub fn reset_included_fee_detail_list(&mut self) {
    self.included_fee_detail_list = None;
  }
